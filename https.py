...
def hash_user_id(user_id):
    ...
    # Les objets de hachage nécessitent des bytes, donc nous devons convertir notre ID d'utilisateur en bytes
    hasher.update(str(user_id).encode())
    # Hexdigest retourne le hachage en format hexadécimal
...
# # Remplit le hashmap avec les données
# for user_id, history_data in user_histories_data.items():
#     user_histories.append(int(user_id), CommandHistory.from_dict(history_data))
